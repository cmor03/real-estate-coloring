...
export async function POST(request: NextRequest) {
  try {
    ...
    The image should be in a clean, simple line art style suitable for children to color in. 
