...
import { getFirestore, enableIndexedDbPersistence, enableNetwork, disableNetwork, Firestore } from 'firebase/firestore';
import { getStorage, ref, getMetadata, FirebaseStorage } from 'firebase/storage';
